...
public class MedRemInfo extends AppCompatActivity {
    TextView name,info,interval,unit,freq,startTime,startDate,endDate,title,count; //TODO: Handle Weekdays
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        count = (TextView) findViewById(R.id.count_rm);
        ...
        count.setText(ar.get(11).toString());
