...
public class HealthTipsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent navigationIntent = new Intent(HealthTipsActivity.this,NavigationActivity.class);
            startActivity(navigationIntent);
        } else if (id == R.id.nav_profile) {
            Intent profileIntent = new Intent(HealthTipsActivity.this, ProfileActivity.class);
            startActivity(profileIntent);
        } else if (id == R.id.nav_history) {
            Intent historyIntent = new Intent(HealthTipsActivity.this, MedicalHistoryActivity.class);
            startActivity(historyIntent);
        } else if (id == R.id.nav_reminder) {

        } else if (id == R.id.nav_sub) {
            Intent subprofileIntent = new Intent(HealthTipsActivity.this,SubProfileActivity.class);
            startActivity(subprofileIntent);
        } else if (id == R.id.nav_about) {
            Intent aboutIntent = new Intent(HealthTipsActivity.this, AboutActivity.class);
            startActivity(aboutIntent);
        } else if (id == R.id.nav_log) {
            FirebaseAuth.getInstance().signOut(); //End user session
            startActivity(new Intent(HealthTipsActivity.this, LoginActivity.class)); //Go back to home page
            finish();
        }
    ...
    private void setData() {
        ...
        adapter = new FirebaseRecyclerAdapter<Item , ItemViewHolder>(options) {
                    ...
                    { ItemViewHolder viewHolder = (ItemViewHolder)holder;
                        ...
                        viewHolder.setItemClickListener(new ItemClickListener() {
                            ...
                            public void onClick(View view, int position, boolean b) {
                                Toast.makeText(HealthTipsActivity.this, "" + items.get(position).getText(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    break;
            ...
            public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                ...
                {
                    View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_with_child_healthtips,viewGroup,false);
